...
const getEmployeeById = async (request, response) => {
  await Controller.handleRequest(request, response, service.getEmployeeById);
};
...
const getSurveyGroupByEmployeeId = async (request, response) => {
  await Controller.handleRequest(request, response, service.getSurveyGroupByEmployeeId);
};

const updateEmployeeByID = async (request, response) => {
  await Controller.handleRequest(request, response, service.updateEmployeeByID);
};
